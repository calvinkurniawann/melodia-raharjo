    ...
    <footer class="bg-white dark:bg-gray-900">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <div class="flex flex-row items-center">
                        ...
                        <a href="/" class="text-white font-bold text-3xl">Melo<span class="text-[#00ccff]">Gita</span></a>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul class="text-gray-500 dark:text-gray-400 font-medium">
                            ...
                            <li>
                                <a href="#" class="hover:underline">Order</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">MeloGita™</a>. All Rights Reserved.</span>
                
                <div class="flex mt-4 sm:justify-center sm:mt-0">
                    <!-- Add your custom icons or social media links here -->
