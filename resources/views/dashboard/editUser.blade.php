<x-app-layout>
    <x-slot name="header">
        <p class="text-3xl">Edit User</p>
    </x-slot>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg py-5">
                <form class="max-w-sm mx-auto" action="{{ "/dashboard/user/". $user->id}}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-5">
                        <label for="nama"
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="utype" name="utype" value="{{ $user->utype }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-[15px] rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:focus:ring-blue-500 dark:focus:border-blue-500"
